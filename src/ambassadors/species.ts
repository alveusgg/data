...
const species = {
  ...
  macawBlueAndGold: {
    ...
    lifespan: {
      wild: 50,
      captivity: 70,
      // source: https://animaldiversity.org/accounts/Ara_ararauna/#lifespan_longevity
    },
    birth: "egg",
    class: "aves",
  },
  ...
  wolfHybrid: {
    ...
    lifespan: {
      ...
      // source: https://wolf.org/wolf-info/basic-wolf-info/wolves-and-humans/wolf-dog-hybrids/
    },
    birth: "live",
    class: "mammalia",
  },
